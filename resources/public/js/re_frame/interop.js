...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9822 = cljs.core.instance_QMARK_;
var expr__9823 = reactive_val;
if(cljs.core.truth_(pred__9822.call(null,reagent.ratom.RAtom,expr__9823))){
return "ra";
} else {
if(cljs.core.truth_(pred__9822.call(null,reagent.ratom.RCursor,expr__9823))){
return "rc";
} else {
if(cljs.core.truth_(pred__9822.call(null,reagent.ratom.Reaction,expr__9823))){
return "rx";
} else {
if(cljs.core.truth_(pred__9822.call(null,reagent.ratom.Track,expr__9823))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1512758124819
