...
return (new CustomEvent(event_name,(function (){var obj33997 = {"detail":data};
return obj33997;
})()));
} else {
...
var f = (function (){var pred__34004 = cljs.core._EQ_;
var expr__34005 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34004.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34005))){
return ((function (pred__34004,expr__34005){
return (function (p1__33998_SHARP_){
return console.warn(p1__33998_SHARP_);
});
;})(pred__34004,expr__34005))
} else {
if(cljs.core.truth_(pred__34004.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34005))){
return ((function (pred__34004,expr__34005){
return (function (p1__33999_SHARP_){
return console.debug(p1__33999_SHARP_);
});
;})(pred__34004,expr__34005))
} else {
if(cljs.core.truth_(pred__34004.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34005))){
return ((function (pred__34004,expr__34005){
return (function (p1__34000_SHARP_){
return console.error(p1__34000_SHARP_);
});
;})(pred__34004,expr__34005))
} else {
return ((function (pred__34004,expr__34005){
return (function (p1__34001_SHARP_){
return console.log(p1__34001_SHARP_);
});
;})(pred__34004,expr__34005))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34008){
...
var eval_fn = cljs.core.get.call(null,map__34009__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34011_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34013,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1513010303949
